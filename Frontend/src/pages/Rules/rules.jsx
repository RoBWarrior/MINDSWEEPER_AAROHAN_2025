...
const RulesPage = () => {
  return (
    <div className="bg-gradient-to-br from-[#020617] via-[#0f172a] to-[#1e293b] text-white flex justify-center min-h-screen">
     
      <div
        className="w-full max-w-5xl px-6 sm:px-10 py-8 flex flex-col items-center overflow-y-auto"
      ...
      >
        ...
        <div className="mt-8 w-full text-center text-xs text-white/60">
